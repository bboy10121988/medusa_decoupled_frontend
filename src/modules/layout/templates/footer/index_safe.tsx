...
export default async function Footer() {
  ...
  // 聯絡資訊改從第三個自訂區塊 sections[2]?.customInfo 讀取
  const contactInfo = (Array.isArray(footerData?.sections) && footerData.sections[2]?.customInfo) || null
          ...
          <div className="grid grid-cols-1 gap-8 py-12 lg:grid-cols-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {contactInfo ? (
                  <>
                    <p className="text-sm text-gray-600">電話: {contactInfo.phone || "N/A"}</p>
                    <p className="text-sm text-gray-600">信箱: {contactInfo.email || "N/A"}</p>
                  </>
                ) : (
                  <>
                    <p className="text-sm text-gray-600">電話: N/A</p>
                    <p className="text-sm text-gray-600">信箱: N/A</p>
                  </>
                )}
              </div>
