            ...
            {footer?.sections?.map((section, index) => (
              <div key={index} className="space-y-6">
                ...
                {index === (footer?.sections?.length ?? 0) - 1 && (
                  <div className="mt-6">
                    {/* 若第三個自訂區塊有 customInfo，顯示其聯絡資訊或自訂文字 */}
                    {Array.isArray(footer?.sections) && footer.sections[2]?.customInfo && (
                      <div className="mb-4">
                        {footer.sections[2].customInfo.phone && (
                          <p className="text-body-small mb-2">
                            電話：<br />{footer.sections[2].customInfo.phone}
                          </p>
                        )}
                        {footer.sections[2].customInfo.email && (
                          <p className="text-body-small mb-4">
                            Email：<br />{footer.sections[2].customInfo.email}
                          </p>
                        )}
                        {footer.sections[2].customInfo.text && (
                          <p className="text-body-small">{footer.sections[2].customInfo.text}</p>
                        )}
                      </div>
                    )}
