          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-y-10 md:gap-x-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {Array.isArray(footer?.sections) && footer.sections[2]?.customInfo?.phone && (
                  <div className="text-body-small">
                    <span className="text-gray-600">電話: </span>
                    <a href={`tel:${footer.sections[2].customInfo.phone}`} className="hover:text-black transition-colors">
                      {footer.sections[2].customInfo.phone}
                    </a>
                  </div>
                )}
                {Array.isArray(footer?.sections) && footer.sections[2]?.customInfo?.email && (
                  <div className="text-body-small">
                    <span className="text-gray-600">信箱: </span>
                    <a href={`mailto:${footer.sections[2].customInfo.email}`} className="hover:text-black transition-colors">
                      {footer.sections[2].customInfo.email}
                    </a>
                  </div>
                )}
                {Array.isArray(footer?.sections) && footer.sections[2]?.customInfo?.text && (
                  <div className="text-body-small">
                    {footer.sections[2].customInfo.text}
                  </div>
                )}
              </div>
            </div>
