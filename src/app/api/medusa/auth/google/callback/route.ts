...
// 前端應該使用 src/app/(main)/[countryCode]/(main)/auth/google/callback/page.tsx 處理回調
...
export async function POST(request: NextRequest) {
  return NextResponse.json({ 
    error: '此API已廢棄',
    message: 'Google OAuth callback 由 Medusa 後端處理，請使用頁面路由 /[countryCode]/auth/google/callback',
